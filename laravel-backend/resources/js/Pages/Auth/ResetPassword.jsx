                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                value={data.email}
                                readOnly
                                className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-300 cursor-not-allowed"
                            />
                        </div>
                    </div>
