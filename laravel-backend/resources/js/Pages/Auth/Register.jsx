                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 border ${errors.name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                    ...
                    <div>
                        <label className="flex items-start">
                            <input
                                ...
                                className={`mt-1 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 ${errors.terms ? 'border-red-500' : ''
                                    }`}
                            />
