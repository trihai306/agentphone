...
export default function Index() {
    ...
    return (
        <LandingLayout>
            <div className="overflow-x-hidden bg-[#030712]">
                <SeoHead
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <AnimatedSection animation="fadeUp" className="text-center lg:text-left space-y-8">
                                ...
                                <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full backdrop-blur-sm">
                                    ...
                                    <span className="text-xs font-semibold text-violet-300 tracking-wider uppercase">No-Code Automation Platform</span>
                                </div>
                                ...
                                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                                    ...
                                    <span className="block text-2xl sm:text-3xl lg:text-4xl font-medium text-gray-400 mt-2">
                                        Thông Minh & Hiệu Quả
                                    </span>
                                </h1>
                                ...
                                <p className="text-lg text-gray-400 max-w-xl leading-relaxed">
                                    Nền tảng <strong className="text-white">No-Code</strong> kéo thả workflow.{' '}
                                    <strong className="text-white">Vision AI</strong> nhận diện UI, thao tác như người thật 24/7 trên hàng trăm thiết bị.
                                </p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    ...
                                    <Link
                                        href="/features"
                                        className="inline-flex items-center justify-center px-8 py-4 font-semibold text-gray-300 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl transition-all duration-300 backdrop-blur-sm"
                                    >
                            ...
                            <div className="lg:hidden flex justify-center">
                                <div className="relative w-64 h-64">
                                    ...
                                    <div className="absolute inset-4 bg-gradient-to-br from-violet-600/10 to-cyan-500/10 rounded-full backdrop-blur-sm border border-white/5 flex items-center justify-center">
                                        <svg className="w-20 h-20 text-violet-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* ═══════════════════════════════════════════════
                    SECTION 2: STATS
                ═══════════════════════════════════════════════ */}
                <section className="relative py-20 border-y border-white/5" aria-label="Thống kê">
                ...
                {/* ═══════════════════════════════════════════════
                    SECTION 3: FEATURES
                ═══════════════════════════════════════════════ */}
                <section className="py-24 lg:py-32" aria-label="Tính năng" id="features">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <AnimatedSection animation="fadeUp" className="text-center mb-16 lg:mb-20">
                            <span className="inline-block text-xs font-semibold text-violet-400 tracking-widest uppercase mb-4">Tính Năng</span>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {features.map((feature, i) => (
                                <AnimatedSection key={feature.title} animation="fadeUp" delay={i * 80}>
                                    <div className="group relative h-full p-6 lg:p-8 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.06] hover:border-white/[0.12] rounded-2xl transition-all duration-500 backdrop-blur-sm">
                ...
                ═══════════════════════════════════════════════ */}
                <section className="py-24 lg:py-32 relative" aria-label="Cách hoạt động" id="how-it-works">
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-violet-600/[0.03] to-transparent" />
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <AnimatedSection animation="fadeUp" className="text-center mb-16 lg:mb-20">
                            <span className="inline-block text-xs font-semibold text-cyan-400 tracking-widest uppercase mb-4">Cách Hoạt Động</span>
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 relative">
                            {/* Connection line */}
                            <div className="hidden md:block absolute top-16 left-[20%] right-[20%] h-px bg-gradient-to-r from-violet-500/30 via-purple-500/30 to-cyan-500/30" />
                                ...
                                <AnimatedSection key={item.step} animation="fadeUp" delay={i * 150}>
                                    <div className="relative text-center">
                                        <div className="w-16 h-16 mx-auto mb-6 relative">
                                            ...
                                            <div className="absolute -top-2 -right-2 w-7 h-7 bg-[#030712] border-2 border-violet-500 rounded-full flex items-center justify-center">
                ...
                {/* ═══════════════════════════════════════════════
                    SECTION 5: USE CASES
                ═══════════════════════════════════════════════ */}
                <section className="py-24 lg:py-32" aria-label="Ứng dụng" id="use-cases">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <AnimatedSection animation="fadeUp" className="text-center mb-16">
                            <span className="inline-block text-xs font-semibold text-emerald-400 tracking-widest uppercase mb-4">Ứng Dụng Thực Tế</span>
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        {useCases[activeUseCase].stats.map((stat) => (
                                            <div key={stat.label} className="text-center p-4 bg-white/[0.03] rounded-2xl border border-white/[0.06]">
                                                <div className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent mb-1">
                                                    {stat.value}
                                                </div>
                ...
                ═══════════════════════════════════════════════ */}
                <section className="py-16 border-y border-white/5" aria-label="Đối tác">
                            ...
                            <div className="flex animate-[scroll_30s_linear_infinite] gap-16 items-center px-8">
                                {[...Array(2)].flatMap((_, setIdx) =>
                                    ['Phone Farm Pro', 'AutoTech', 'NickMaster', 'FarmCloud', 'DeviceHub', 'SmartBot', 'FlowAI', 'TestPilot'].map((name, i) => (
                                        <div key={`${setIdx}-${i}`} className="flex-shrink-0 text-gray-600 font-bold text-xl tracking-wider opacity-40 hover:opacity-70 transition-opacity select-none">
                                            {name}
                                        </div>
                                    ))
                                )}
                ...
                {/* ═══════════════════════════════════════════════
                    SECTION 7: FAQ
                ═══════════════════════════════════════════════ */}
                <section className="py-24 lg:py-32" aria-label="Câu hỏi thường gặp" id="faq">
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                        <AnimatedSection animation="fadeUp" className="text-center mb-16">
                            <span className="inline-block text-xs font-semibold text-amber-400 tracking-widest uppercase mb-4">FAQ</span>
                        ...
                        <div className="space-y-3">
                            {faqData.map((faq, i) => (
                                <AnimatedSection key={i} animation="fadeUp" delay={i * 60}>
                                    <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl overflow-hidden transition-colors hover:border-white/[0.1]">
                                        <button
                ...
                {/* ═══════════════════════════════════════════════
                    SECTION 8: CTA
                ═══════════════════════════════════════════════ */}
                <section className="py-24 lg:py-32 relative overflow-hidden" aria-label="Bắt đầu ngay">
                    {/* Background effects */}
                    <div className="absolute inset-0">
                        <div className="absolute inset-0 bg-gradient-to-br from-violet-600/10 via-purple-600/5 to-cyan-500/10" />
                    ...
                    <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <AnimatedSection animation="scaleUp">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Link
                                    href="/contact"
                                    className="inline-flex items-center justify-center px-10 py-4 font-semibold text-gray-300 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl transition-all duration-300"
                                >
                                    Liên Hệ Tư Vấn
                                </Link>
                            </div>
