            ...
            <div className={`min-w-80 max-w-md p-4 bg-gradient-to-r ${config.bg} border ${config.border} rounded-xl shadow-lg backdrop-blur-lg`}>
                <div className="flex items-start space-x-3">
                    ...
                    <button
                        ...
                        className="flex-shrink-0 p-1 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors hover:bg-black/5 dark:hover:bg-white/10"
                    >
