            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: isRunning || isSuccess || isError
                        ...
                        : selected
                            ? isDark
                                ? '0 0 20px rgba(59, 130, 246, 0.15), 0 4px 20px rgba(0, 0, 0, 0.4)'
                                : '0 0 20px rgba(59, 130, 246, 0.2), 0 4px 20px rgba(0, 0, 0, 0.1)'
                            : isDark
            ...
            >
                ...
                >
                    ...
                    <span className={`text-xs font-bold uppercase tracking-wider transition-colors ${isRunning ? 'text-indigo-400' :
                        ...
                        {isRunning ? 'Processing...' : isSuccess ? 'Done' : isError ? 'Error' : 'Process'}
                    </span>
                </div>
